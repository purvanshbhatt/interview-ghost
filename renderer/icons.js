...
(function () {
  const P = {
    ...
    coffee: '<path d="M10 2v2"/><path d="M14 2v2"/><path d="M2 6h16a2 2 0 0 1 2 2v4a6 6 0 0 1-12 0V8"/><path d="M2 6v6a6 6 0 0 0 6 6h4a6 6 0 0 0 6-6V6"/><path d="M18 8h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2"/>',
  ...
  // Ghost bespoke logo — a sleek ethereal phantom with glowing stealth eyes and flowing shroud.
  const LOGO = '<svg viewBox="0 0 24 24" width="SIZE" height="SIZE" fill="none" xmlns="http://www.w3.org/2000/svg">' +
    '<path d="M12 2C7.58 2 4 5.58 4 10v9.5c0 .74.84 1.17 1.42.71L7.5 18.5l2.29 1.83a1 1 0 0 0 1.25 0L12 19.5l.96.83a1 1 0 0 0 1.25 0L16.5 18.5l2.08 1.71c.58.46 1.42-.03 1.42-.71V10c0-4.42-3.58-8-8-8z" fill="currentColor" fill-opacity="0.22" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>' +
